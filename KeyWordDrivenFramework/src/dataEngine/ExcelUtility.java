...
public class ExcelUtility {
	public static String readCell(String filePath, String fileName, String sheetName, int row, int column)
			throws IOException {
		...
		Sheet Excelsheet = loginWorkbook.getSheet(sheetName);

		// Get required row
		Row Excelrow = Excelsheet.getRow(row);
		String stringCellValue = Excelrow.getCell(column).getStringCellValue();
		inputStream.close();
